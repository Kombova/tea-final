...
const ProductCard = ({product}) =>{
   ...
   return(  
        <li  className="w-[290px] h-[440px] rounded-[15px] shadow-2xl overflow-none" style={{ boxShadow: '2px 2px 7px rgba(34, 31, 31, 0.4)' }}>
            ...
            <div className="px-[10px] mt-3">
                ...
                <p className="w-full mt-2 flex justify-between font-normal color-[#001011]">Ціна :<span className="text-[20px] font-semibold color-[#001011] ">{price} грн</span></p>

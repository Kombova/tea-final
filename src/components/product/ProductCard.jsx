   ...
   return(  
        <li  className="w-[290px] h-[462px] rounded-[15px] shadow-2xl overflow-none" style={{ boxShadow: '2px 2px 7px rgba(34, 31, 31, 0.4)' }}>
            ...
            <div className="px-[10px] mt-3">
                ...
                <ControleCard step={product.fields.category.fields.step} setPrice={setPrice} initialPrice={+product.fields.price} id={product.sys.id} price={price} title={product.fields.title} img={image} category={product.fields.category.sys.contentType.sys.id}/>
